/* Returns an array of document metadata containing each locale a document has been translated into.
 
A `lang_name` property is included in each document containing the document's locale name as it is configured in the Prismic repository. */
